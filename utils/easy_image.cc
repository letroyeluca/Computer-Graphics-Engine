...
Matrix img::EasyImage::scaleFigure(const double scale){
    Matrix matrix;
    // Initialize to identity matrix first
    for(int i = 1; i <= 4; i++) {
        for(int j = 1; j <= 4; j++) {
...
Matrix img::EasyImage::rotateX(const double angle){
    Matrix matrix;
    // Initialize to identity matrix first
    for(int i = 1; i <= 4; i++) {
        for(int j = 1; j <= 4; j++) {
...
Matrix img::EasyImage::rotateY(const double angle){
    Matrix matrix;
    // Initialize to identity matrix first
    for(int i = 1; i <= 4; i++) {
        for(int j = 1; j <= 4; j++) {
...
Matrix img::EasyImage::rotateZ(const double angle){
    Matrix matrix;
    // Initialize to identity matrix first
    for(int i = 1; i <= 4; i++) {
        for(int j = 1; j <= 4; j++) {
...
Matrix img::EasyImage::translate(const Vector3D &vector){
    Matrix matrix;
    // Initialize to identity matrix first
    for(int i = 1; i <= 4; i++) {
        for(int j = 1; j <= 4; j++) {
...
void img::EasyImage::applyTransformation(Figure &fig, const Matrix &m){
...
Matrix img::EasyImage::eyePointTrans(const Vector3D &eyepoint) {
    Matrix matrix;
...
std::vector<img::Line2D> img::EasyImage::doProjection(const std::vector<Figure> &figures){
...
img::Point2D img::EasyImage::doProjection(const Vector3D &point,const double d){
